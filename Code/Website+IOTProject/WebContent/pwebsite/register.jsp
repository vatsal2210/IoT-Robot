...
<div class="login-right">
	<div class="container">
		<h3>Register</h3>
		<div class="login-top">
			<form method="post" action="VRegister" class="form-horizontal contact-form">
				
				<div class="form-group">
				
					 <label class="col-sm-3 control-label">Name </label>
					 	 <div class="col-sm-9">
							<input type="text" class="contact-name" placeholder="Your Name" required="" name="name">
						</div>
				</div>
				...
				<div class="form-group">
                 ...
                 <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3">
				        	...
				        	<button type="submit" class="button solid-button purple" >Sign Up</button>
                        </div>
                 </div>

			</form>
			
				<h4> <p> Already have a Robot Control account? <a href="VLogin">Login</a> </p> </h4>
		</div>		
	</div>
</div>
<br><br>
